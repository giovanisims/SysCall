...
async def verificar(password: str = Form(...), password_confirm: str = Form(...)):
    ...
    if password_confirm == "cursedshrekHOLY":
        return RedirectResponse(url="https://imgix.ranker.com/user_node_img/50105/1002095730/original/1002095730-photo-u1?auto=format&q=60&fit=crop&fm=pjpg&dpr=2&w=500", status_code=303)
